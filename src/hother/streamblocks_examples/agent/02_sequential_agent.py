...
from hother.streamblocks import BlockEndEvent, TextDeltaEvent
from hother.streamblocks_examples.agent.display import AgentEventRenderer, console
...
from hother.streamblocks_examples.agent.executor import ToolExecutor
from hother.streamblocks_examples.agent.sequential_stream import SequentialAgentStream
from hother.streamblocks_examples.agent.tools import (
    COMPLEX_TASK,
    DateRange,
    Filter,
    OrderItem,
...
Returns:
    ...
    # Display the full system prompt
    console.print("=" * 80)
    console.print("[bold cyan]SYSTEM PROMPT[/]")
    console.print("=" * 80)
    console.print(stream.system_prompt)
    console.print("=" * 80)
    console.print()
    ...
    async for event in stream.run(task):
        if isinstance(event, TextDeltaEvent):
            ...
            from hother.streamblocks_examples.agent.display import truncate
