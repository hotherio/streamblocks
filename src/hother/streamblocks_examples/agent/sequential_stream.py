...
from hother.streamblocks_examples.agent.blocks import FinalAnswer, ToolCall
...
if TYPE_CHECKING:
    ...
    from hother.streamblocks_examples.agent.executor import ToolDefinition, ToolExecutor
