...
async def compare_modes() -> None:
    ...
    processor_normal = StreamBlockProcessor(
        registry,
        emit_original_events=True,  # Default
    )
    ...
    processor_light = StreamBlockProcessor(
        registry,
        emit_original_events=False,  # Disable passthrough
    )
